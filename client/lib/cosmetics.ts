...
export const COSMETIC_TAILWIND_VALUE_SAFELIST = [
  ...
  "bg-gradient-to-r from-red-500 via-yellow-500 to-blue-500 text-transparent bg-clip-text animate-pulse",
  "bg-gradient-to-r from-purple-400 to-pink-600 text-transparent bg-clip-text font-bold",
  "text-lime-500 animate-pulse drop-shadow-[0_0_8px_rgba(132,204,22,0.9)]",
